...
const App: React.FC = () => {
  ...
  const reset = () => {
    if(window.confirm("DESEJA LIMPAR TODOS OS ARQUIVOS PROCESSADOS?")) {
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 border-b-2 border-zinc-800 pb-10">
              <div>
                <h3 className="text-5xl font-black uppercase tracking-tighter mb-2">
                  ARQUIVOS <span className="text-yellow-brand">GERADOS</span>
                </h3>
                <p className="text-zinc-500 font-bold uppercase text-xs tracking-[0.3em]">Total de Documentos: {state.files.length}</p>
              </div>
